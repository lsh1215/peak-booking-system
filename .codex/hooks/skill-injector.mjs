...
// Standalone skill injector hook for Codex/Claude-compatible local skills.
// Scans .codex/skills/*/SKILL.md first, then legacy .claude skill/command files with
...
function findSkillFiles(cwd) {
  ...
  // Codex project/global skills first, then legacy Claude locations.
